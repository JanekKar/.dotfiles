...
nnoremap("<leader>d", ":lua vim.lsp.diagnostic.set_loclist()<CR>")
nnoremap("<leader>nd", [[<cmd>lua vim.diagnostic.goto_next()<CR>]])
nnoremap("<leader>pd", [[<cmd>lua vim.diagnostic.goto_prev()<CR>]])
